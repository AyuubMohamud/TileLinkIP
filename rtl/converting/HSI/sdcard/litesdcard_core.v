...
reg           litesdcardcore_crc16inserter_next_state = 1'd0;
reg           litesdcardcore_crc16inserter_state = 1'd0;
wire   [31:0] litesdcardcore_dat_r;
reg    [31:0] litesdcardcore_dat_w = 32'd0;
reg     [2:0] litesdcardcore_fsm_next_state = 3'd0;
reg     [2:0] litesdcardcore_fsm_state = 3'd0;
reg     [1:0] litesdcardcore_sdblock2memdma_next_state = 2'd0;
reg     [1:0] litesdcardcore_sdblock2memdma_state = 2'd0;
reg     [1:0] litesdcardcore_sdmem2blockdma_next_state = 2'd0;
reg     [1:0] litesdcardcore_sdmem2blockdma_state = 2'd0;
...
always @(*) begin
    litesdcardcore_crc16inserter_next_state <= 1'd0;
    ...
    litesdcardcore_crc16inserter_next_state <= litesdcardcore_crc16inserter_state;
    case (litesdcardcore_crc16inserter_state)
        1'd1: begin
        ...
        default: begin
            ...
            if ((sdcard_core_crc16_inserter_sink_valid & sdcard_core_crc16_inserter_sink_ready)) begin
                if (sdcard_core_crc16_inserter_sink_last) begin
                    litesdcardcore_crc16inserter_next_state <= 1'd1;
                end
            end
        end
    endcase
...
always @(*) begin
    ...
    litesdcardcore_fsm_next_state <= 3'd0;
    ...
    litesdcardcore_fsm_next_state <= litesdcardcore_fsm_state;
    case (litesdcardcore_fsm_state)
        1'd1: begin
            ...
            if (cmdw_sink_ready) begin
                ...
                if (cmdw_sink_last) begin
                    if ((sdcard_core_cmd_type == 1'd0)) begin
                        litesdcardcore_fsm_next_state <= 1'd0;
                    end else begin
                        litesdcardcore_fsm_next_state <= 2'd2;
                    end
                end
            end
        end
                ...
                if ((cmdr_source_source_payload_status == 1'd1)) begin
                    ...
                    if (cmdr_source_source_last) begin
                        if ((sdcard_core_data_type == 2'd2)) begin
                            litesdcardcore_fsm_next_state <= 2'd3;
                        end else begin
                            if ((sdcard_core_data_type == 1'd1)) begin
                                litesdcardcore_fsm_next_state <= 3'd4;
                            end else begin
                                litesdcardcore_fsm_next_state <= 1'd0;
                            end
                        end
        ...
        default: begin
            ...
            if (sdcard_core_cmd_send_re) begin
                ...
                sdcard_core_data_timeout_fsm_next_value7 <= 1'd0;
                sdcard_core_data_timeout_fsm_next_value_ce7 <= 1'd1;
                litesdcardcore_fsm_next_state <= 1'd1;
            end
        end
    endcase
end
...
always @(*) begin
    litesdcardcore_sdmem2blockdma_next_state <= 2'd0;
    ...
    litesdcardcore_sdmem2blockdma_next_state <= litesdcardcore_sdmem2blockdma_state;
    case (litesdcardcore_sdmem2blockdma_state)
        1'd1: begin
            ...
            if (sdcard_mem2block_dma_sink_sink_ready) begin
                ...
                if (sdcard_mem2block_dma_sink_sink_last) begin
                    if (sdcard_mem2block_dma_loop_storage) begin
                        ...
                        litesdcardcore_sdmem2blockdma_next_state <= 2'd2;
                    end
                end
            end
        end
        ...
        default: begin
            sdcard_mem2block_dma_offset_sdmem2blockdma_next_value <= 1'd0;
            sdcard_mem2block_dma_offset_sdmem2blockdma_next_value_ce <= 1'd1;
            litesdcardcore_sdmem2blockdma_next_state <= 1'd1;
        end
    endcase
end
...
always @(posedge sys_clk) begin
    ...
    litesdcardcore_crc16inserter_state <= litesdcardcore_crc16inserter_next_state;
    ...
    litesdcardcore_fsm_state <= litesdcardcore_fsm_next_state;
    ...
    litesdcardcore_sdmem2blockdma_state <= litesdcardcore_sdmem2blockdma_next_state;
    ...
    if (sdcard_mem2block_dma_reset) begin
        ...
        litesdcardcore_sdmem2blockdma_state <= 2'd0;
    end
    ...
    if (sys_rst) begin
        ...
        litesdcardcore_crc16inserter_state <= 1'd0;
        litesdcardcore_fsm_state <= 3'd0;
        litesdcardcore_sdblock2memdma_state <= 2'd0;
        litesdcardcore_sdmem2blockdma_state <= 2'd0;
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2023-08-31 18:15:45.
//------------------------------------------------------------------------------
