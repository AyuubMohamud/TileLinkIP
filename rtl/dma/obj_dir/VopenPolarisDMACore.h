...
#ifndef VERILATED_VOPENPOLARISDMACORE_H_
#define VERILATED_VOPENPOLARISDMACORE_H_  // guard

#include "verilated.h"

class VopenPolarisDMACore__Syms;
class VopenPolarisDMACore___024root;
class VerilatedVcdC;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) VopenPolarisDMACore VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    VopenPolarisDMACore___024root* const rootp;
    ...
    explicit VopenPolarisDMACore(VerilatedContext* contextp, const char* name = "TOP");
    explicit VopenPolarisDMACore(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~VopenPolarisDMACore();
  private:
    VL_UNCOPYABLE(VopenPolarisDMACore);  ///< Copying not allowed
