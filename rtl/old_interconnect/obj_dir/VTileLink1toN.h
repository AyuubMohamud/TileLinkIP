...
#ifndef VERILATED_VTILELINK1TON_H_
#define VERILATED_VTILELINK1TON_H_  // guard

#include "/opt/oss-cad-suite/share/verilator/include/verilated.h"

class VTileLink1toN__Syms;
class VTileLink1toN___024root;
class VerilatedVcdC;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) VTileLink1toN VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    VTileLink1toN___024root* const rootp;
    ...
    explicit VTileLink1toN(VerilatedContext* contextp, const char* name = "TOP");
    explicit VTileLink1toN(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~VTileLink1toN();
  private:
    VL_UNCOPYABLE(VTileLink1toN);  ///< Copying not allowed
